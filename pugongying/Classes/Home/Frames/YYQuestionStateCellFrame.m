...
@implementation YYQuestionStateCellFrame
- (void)setModel:(YYQuestionStateModel *)model{
    _model = model;
    ...
    self.cellRowHeight = YY12HeightMargin + 35 + YY12HeightMargin + self.contentHeight + YY10HeightMargin + 14 + YY10HeightMargin + YY10HeightMargin + 16 + YY10HeightMargin;
