...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    attr1[NSFontAttributeName] = detailsLabel.font;
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attr1 context:nil].size;
